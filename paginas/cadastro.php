...
<div class="row">
    ...
    <div class="col-md-6">
		...
		<div class="form-group">
			<label for="exampleInputEmail1">Nome do medicamento:</label>
		...
		<div class="form-group">
			<label for="exampleInputName1">Descrição sobre o medicamento:</label>
			<input type="text" class="form-control" id="exampleInputName1" name="descricao" placeholder="Digite uma descrição para o produto">
		</div>

		<div class="form-group">
			<label for="exampleInputTelefone1">Valor do medicamento:</label>
